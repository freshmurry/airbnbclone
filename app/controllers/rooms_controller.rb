class RoomsController < ApplicationController
  ...
  private
    ...
    def room_params
      params.require(:room).permit(:home_type, :room_type, :accommodate, :bed_room, :bath_room, :listing_name, :summary, :address, :is_kitchen, :is_tv, :is_self_parking, 
      :is_valet_parking, :is_garage_parking, :is_air, :is_heating, :is_wifi, :is_handi_accessible, :is_bar, :price, :active, :instant)
    end
end