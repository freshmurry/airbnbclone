module ApplicationHelper
  ...
  # ---- LIVE ----
  "https://connect.stripe.com/express/oauth/authorize?redirect_uri=https://airbnbclone.herokuapp.com/auth/stripe_connect/callback&client_id={CONNECTED_STRIPE_ACCOUNT_ID}&state={STATE_VALUE}"
  end
end